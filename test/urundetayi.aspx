<%@ Page Language="C#" AutoEventWireup="true"  EnableEventValidation="false" CodeBehind="urundetayi.aspx.cs" Inherits="test.urundetayi" %>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-7">
                                    <div class="product-content">
                                        <div class="title"><h2><asp:Label ID="Label1" runat="server"></asp:Label> </h2></div>
                                        <div class="ratting">
                                        ...
                                        <div class="price">
                                            <h4>Fiyat:</h4>
                                            <p><asp:Label ID="Label2" runat="server"></asp:Label> <span></span></p>
                                        </div>
                                        <div class="quantity">
                                            <h4>Adet:</h4>
                                            <div class="qty">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="tab-content">
                                    <div id="description" class="container tab-pane active">
                                        <h4>Ürün Detayı</h4>
                                        <p >
                                            <asp:Label ID="detay" runat="server"></asp:Label>
